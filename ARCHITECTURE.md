# Architecture: Atharva Society Management System

## Overview

A full-stack society management web application for **Atharva Society** housing society (~40 flats). The system handles maintenance collection via Razorpay (₹1000/month + ₹100 late fee), lift emergency alerts via email, complaints with image uploads, asset tracking, and a dedicated watchman portal. Built with Next.js 14 + Express.js + MongoDB, deployed on Vercel + Render.
...
- **Production:** `https://api.atharvasociety.com/api`
...
```
Subject: 🏠 Maintenance Due - {Month} {Year} | Atharva Society
...
```
Subject: ⏰ Reminder: Maintenance Payment Pending | Atharva Society
...
```
Subject: ⚠️ Final Notice: Pay Before Late Fee Applies | Atharva Society
...
```
Subject: ✅ Payment Received - Thank You! | Atharva Society
...
```
Subject: 🚨 LIFT EMERGENCY - Atharva Society
...
---
This is an automated alert from Atharva Society Management System.
```

### 6. Emergency Resolved
```
Subject: ✅ Lift Emergency Resolved | Atharva Society
...
```
Subject: 🔐 Password Reset OTP | Atharva Society
...
```
Subject: 📋 Complaint Status Updated | Atharva Society
...
# Database
MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/atharva_society?retryWrites=true&w=majority
...
This architecture document provides a comprehensive blueprint for building the Atharva Society Management System. All major decisions have been documented with rationale, and the system is designed for future extensibility.
