# UI/UX Design Specification: Atharva Society Management
...
**Typography for Logo:**
- Primary Text: **"Atharva Society"** - Font: Inter Bold, 24px
...
```
┌────────────────────────────────────────────────────────────────────┐
│  🏢 Atharva Society          Welcome, Resident (Flat 101)   [👤]   │
├──────────────┬─────────────────────────────────────────────────────┤
│              │                                                      │
│   🏠 Home    │   ┌──────────────────────────────────────────────┐ │
...
┌──────────────────┐
│                  │
│  🏢 Atharva     │  <- Logo area (padding 24px)
│     Society      │
│                  │
├──────────────────┤
│                  │
